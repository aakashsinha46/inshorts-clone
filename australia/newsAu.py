...
news_links = {}
prepared_links = {}
CATEGORY = ['world', 'lifestyle', 'entertainment', 'technology', 'finance', 'sport', 'lifestyle/health', 'lifestyle/fashion']
news_links={}
link=[]
...
def main():
   ...
   with open('newsAu.json', 'w') as f:          #the output at independent_output.json
