...
def get_soup(category:None):
   return get_soup_html("https://techcrunch.com/{link}".format(link=category))
...
def main():
   ...
   with open('{path}/singapore/techcrunch.json'.format(path=masterPath), 'w') as f:          #the output at independent_output.json
